...
import com.ssm.entity.Condition;
...
public class UserController {
    ...
    public User getInfo(@RequestParam("id") Integer id){
        User user = new User();
        user.setId(id);
        user.getName();
        user.getAddress();
    ...
    //普通查询
    @RequestMapping
    public User query(Condition condition){
        System.out.println(condition);
        /*System.out.println("传来的参数1是："+id);
        System.out.println("传来的参数2是："+username);
        System.out.println("传来的参数3是："+password);
